...
<html lang="en">
<head>
    <title>Boardify Робота з файлами</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Оновлення файлу 1</h6>
...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Заголовок запису</label>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Файл</label>
                                   <a href="folder1/<?php echo $row->File1;?>" width="100" height="100" target="_blank"> <strong style="color: red">Переглянути</strong></a>


                                </div>
                               
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Завантажити новий файл</label>
