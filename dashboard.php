...
{               ?>
                                <h1><?php?> <span> Панель записів</span></h1><?php $cnt=$cnt+1;}} ?>
                ...
                <div class="row g-8">
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Загальна к-сть завантажених нотаток</p>
                                 <?php 
                                 $uid=$_SESSION['ocasuid'];
...
?>
                                <h4 style="color: blue"><?php echo htmlentities($totnotes);?></h4>
                                        <a href="manage-notes.php"><h5>Детально</h5></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-file fa-6x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Загальна к-сть завантажених файлів нотаток</p>
                                 <?php 
                                 $uid=$_SESSION['ocasuid'];
$sql1 ="SELECT 
