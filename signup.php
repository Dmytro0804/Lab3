...
<head>
    ...
    <title>Boardify Створити акаунт</title>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"></i>Boardify</h3>
                            </a>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="signin.php">Вже маєте акаунт?</a>
                        </div>

                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4" name="submit">Зареєструватися</button>
